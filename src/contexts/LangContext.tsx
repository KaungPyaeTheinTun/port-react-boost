...
const translations = {
  ...
  mm: {
    ...
    about: {
      ...
      database: "Database",
      databaseDesc: "MySQL, MSSQL, Redis",
      p1: "မင်္ဂလာပါ! ကျွန်ုပ်သည် ဒစ်ဂျစ်တယ်ဖြေရှင်းနည်းများကို ဖန်တီးထုတ်လုပ်သည့် အတွေ့အကြုံ 2+ နှစ်ကျော်ရှိသည့် စိတ်အားထက်သန်သော အစုလိုက် developer ဖြစ်သည် ။ ရှုပ်ထွေးသော ပြဿနာများကို ရိုးရှင်းသော၊ လှပပြီး အလိုလိုသိနိုင်သော အပလီကေးရှင်းများအဖြစ်သို့ ပြောင်းလဲခြင်းကို နှစ်သက်ပါသည်။",
      p2: "စိတ်ကြိုက် CMS တစ်ခုကို တည်ဆောက်ရန် ဆုံးဖြတ်လိုက်သောအခါတွင် ကျွန်ုပ်၏ ဝဘ်ဖွံ့ဖြိုးတိုးတက်မှုဆိုင်ရာ ခရီးစဉ်သည် ကောလိပ်တွင် ပြန်လည်စတင်ခဲ့သည် — ဝဘ်ဆိုက်တစ်ခုသည် HTML နှင့် CSS အကြောင်းများစွာကို ကျွန်ုပ်အား ဟက်ကင်းလုပ်ခြင်းမှ သင်ပေးခဲ့ပါသည်။ ထိုအချိန်မှစ၍ ကျွန်ုပ်သည် startup များနှင့် တည်ထောင်ထားသော ကုမ္ပဏီများတွင် အလုပ်လုပ်ခွင့် ရခဲ့ပါသည်။",
    },
