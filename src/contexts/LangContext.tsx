...
const translations = {
  en: {
    ...
    about: {
      ...
      backend: "Backend",
      backendDesc: "Node.js, Python, REST/GraphQL",
      database: "Database",
      databaseDesc: "PostgreSQL, MongoDB, Redis",
      p1: "Hello! I'm a passionate full-stack developer with 5+ years of experience crafting digital solutions. I enjoy turning complex problems into simple, beautiful, and intuitive applications.",
